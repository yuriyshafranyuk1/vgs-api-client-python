...
class CreateAliasesRequestReference(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, alias, format, *args, **kwargs):  # noqa: E501
        """CreateAliasesRequestReference - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, alias, format, *args, **kwargs):  # noqa: E501
        """CreateAliasesRequestReference - a model defined in OpenAPI
